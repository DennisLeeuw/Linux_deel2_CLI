...
\input{disks}
\input{disks-fs}
\input{disks-partition}
\input{disk-free}
\input{disk-usage}
\section{Netwerk}
\input{netwerk_hardware}
\section{Inventarisatie opdracht}
\input{inventarisatie_opdracht}
...
\input{geheugengebruik}
\section{Gebruik door gebruikers}
\input{usermonitoring}
\section{Processen}
% ps
% top
\section{Logging}
