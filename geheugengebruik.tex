...
Swap:            14           0          14
\end{lstlisting}
Met de \texttt{-g} optie geeft \textt{free} de waarden weer in gibi-bytes. In het bovenstaande voorbeeld hebben dus nog 3G vrij van de 31G die er in de machine zit.
